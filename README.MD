...
- Attach Dashboard in the navigation drawer to the Activity Displaying Lists of cryptocurrencies.
...
- Add Activity View for User Profile and attach it to the Navigation Drawer. Here users can add their .
